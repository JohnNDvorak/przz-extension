...
- [ ] Quadrature module passes known integral tests
...
2. `quadrature.py` + tests → Validate on known integrals (∫x^k dx = 1/(k+1)) ← **NEXT**
3. `series.py` + tests → Validate derivative extraction on symbolic examples
