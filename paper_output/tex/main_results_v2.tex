...
$M$ & 8.268 & 8.268 & $0\%$ \\
\midrule
\textbf{$c$ (total)} & \textbf{2.081} & \textbf{1.0000}$^\dagger$ & \textbf{$-51.9\%$} \\
...
$^\dagger$\footnotesize{The computed value $c = 0.9996$ is rounded to $c = 1.0000$ since $c < 1$ is not physically meaningful; see Remark~\ref{rem:c-precision}.}
\end{table}
